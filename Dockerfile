...
COPY content/osxcross-wrapper /usr/bin/osxcross-wrapper
...
ARG GO_SHA=4a7fa60f323ee1416a4b1425aefc37ea359e9d64df19c326a58953a97ad41ea5
RUN set -eux; \
	url="https://golang.org/dl/go${GO_VERSION}.linux-amd64.tar.gz"; \
	wget -O go.tgz "$url" --progress=bar:force:noscroll; \
